...
`,s={uTime:{value:0},uCloudColor:{value:new b(16777215)},uCloudSpeed:{value:o.cloudSpeed},uCloudDensity:{value:o.cloudDensity},uNoiseScale:{value:e?1:2}},S=new N({vertexShader:g,fragmentShader:w,uniforms:s,transparent:!0,blending:W,depthWrite:!1,polygonOffset:e,polygonOffsetFactor:e?1:0,glslVersion:i.capabilities.isWebGL2?G:L}),x=new u(1.01,o.sphereSegments,o.sphereSegments),C=new f(x,S);l.add(C);let d=0;const P=e?16:8;function c(t){requestAnimationFrame(c),!(t-d<P)&&(d=t,s.uTime.value+=e?.008:.01,r.update(),i.render(l,n))}c(0),window.addEventListener("resize",()=>{n.aspect=window.innerWidth/window.innerHeight,n.updateProjectionMatrix();const t=e?Math.min(window.devicePixelRatio,1.5):window.devicePixelRatio;i.setPixelRatio(t),i.setSize(window.innerWidth,window.innerHeight)}),i.domElement.addEventListener("touchstart",t=>{t.preventDefault()},{passive:!1}),i.domElement.addEventListener("touchmove",t=>{t.preventDefault()},{passive:!1})}),(a,e)=>(U(),R("div",null,[...e[0]||(e[0]=[B("canvas",{id:"target-canvas"},null,-1)])]))}}),A=F(O,[["__scopeId","data-v-e6cdb13f"]]);export{A as default};
